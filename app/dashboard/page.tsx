      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            ...
            <div>
              <h1 className="text-3xl font-serif font-bold">Welcome back, {userStats.name}!</h1>
                  ...
                  <div className="space-y-6">
                    {culturalProgress.map((region) => (
                      <div key={region.region}>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">{region.progress}% complete</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center mb-6">
                    ...
                    <p className="text-muted-foreground">Day Learning Streak</p>
                  </div>
                    ...
                    {[...Array(7)].map((_, i) => (
                      <div
                        ...
                        className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
                          i < 7 ? "bg-accent text-accent-foreground" : "bg-muted"
                        }`}
                      >
                        {i + 1}
                      </div>
